...
The packages generated with this **conanfile** can be found in [conan.io](https://conan.io/source/Poco/1.9.4/pocoproject/stable).
...
## Upload Packages to Server
    ...
    $ conan upload Poco/1.9.4@pocoproject/stable --all

## Reuse the Packages

### Basic Setup

    $ conan install Poco/1.9.4@pocoproject/stable
